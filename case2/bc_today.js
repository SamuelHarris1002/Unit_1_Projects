...
// adding the date on the website
var thisDate = new Date();

// 
var dateString = thisDate.toLocaleString();

//putting the variable in the textstring
var dateHTML = "<h2>" + dateString + "</h2>";

//finding the day of the week
var thisDay = thisDate.getDay();

//getting the days events and storing the value
var eventHTML = getEvent(thisDay);

//inserting the ID to the page beofre the end ofthe element contents
